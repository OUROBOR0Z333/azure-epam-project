...
# Deploy Movie Analyst Frontend Application
# Deploys the actual movie-analyst-ui Node.js application from devops-rampup-repo
...
ansible-playbook -i inventory.ini deploy-movie-analyst-frontend.yml
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "You should see the Movie Analyst Frontend UI page showing the application is working!"
    echo ""
